...
describe('Select component', () => {
  ...
  it('should render prompt message', () => {
    const { lastFrame } = render(
      <Select message="Choose one:" choices={choices} onSubmit={vi.fn()} />,
    )
  ...
  it('should render all choices', () => {
    const { lastFrame } = render(<Select message="Select:" choices={choices} onSubmit={vi.fn()} />)
    const output = lastFrame()
  ...
  it('should highlight first item by default', () => {
    const { lastFrame } = render(<Select message="Choose:" choices={choices} onSubmit={vi.fn()} />)
    const output = lastFrame()
  ...
  it('should render with single choice', () => {
    const { lastFrame } = render(
      <Select message="Only option:" choices={['Single']} onSubmit={vi.fn()} />,
    )
    const output = lastFrame()
  ...
  it('should handle empty choices array', () => {
    const { lastFrame } = render(<Select message="No choices:" choices={[]} onSubmit={vi.fn()} />)
    const output = lastFrame()
  ...
  it('should call onSubmit with selected choice', () => {
    ...
    render(<Select message="Choose:" choices={choices} onSubmit={onSubmit} />)
  ...
  it('should render with long choice lists', () => {
    ...
    const { lastFrame } = render(
      <Select message="Pick one:" choices={longChoices} onSubmit={vi.fn()} />,
    )
    const output = lastFrame()
