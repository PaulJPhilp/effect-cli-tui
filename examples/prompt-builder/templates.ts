...
import type { PromptTemplate, UserResponses } from "./types";
...
export const zeroShotTemplate: PromptTemplate = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "choice",
      required: true,
      choices: ["Plain text", "JSON", "Markdown", "Bullet points", "Numbered list", "Table", "XML", "YAML"],
...
export const chainOfThoughtTemplate: PromptTemplate = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      placeholder:
        "e.g., 1. Analyze requirements 2. Design schema 3. Implement...",
    },
    {
      name: "finalAnswer",
