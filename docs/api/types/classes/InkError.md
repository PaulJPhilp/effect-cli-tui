...
[effect-cli-tui](../../modules.md) / [types](../README.md) / InkError

# Class: InkError

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:55](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L55)
...
> **new InkError**(`reason`, `message`): `InkError`

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:56](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L56)

#### Parameters

##### reason

`"RenderError"` | `"ComponentError"` | `"TerminalError"`
...
`Data.TaggedError("InkError").constructor`

## Properties

### \_tag

> `readonly` **\_tag**: `"InkError"`

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Data.d.ts:611

#### Inherited from

`Data.TaggedError("InkError")._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `InkError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`Data.TaggedError("InkError").[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `InkError`, `never`\>

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`Data.TaggedError("InkError").[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `InkError`, `never`\>

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`Data.TaggedError("InkError").[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `InkError`, `never`\>

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`Data.TaggedError("InkError").[StreamTypeId]`
...
Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/typescript@5.9.3/node\_modules/typescript/lib/lib.es2022.error.d.ts:26

The cause of the error.

#### Inherited from

`Data.TaggedError("InkError").cause`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:58](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L58)

#### Inherited from

`Data.TaggedError("InkError").message`
...
Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/typescript@5.9.3/node\_modules/typescript/lib/lib.es5.d.ts:1076

#### Inherited from

`Data.TaggedError("InkError").name`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:57](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L57)
...
Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/typescript@5.9.3/node\_modules/typescript/lib/lib.es5.d.ts:1078

#### Inherited from

`Data.TaggedError("InkError").stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `InkError`, `never`\>\>

Defined in: Projects/Published/effect-cli-tui/node\_modules/.pnpm/effect@3.19.4/node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `InkError`, `never`\>\>

#### Inherited from

`Data.TaggedError("InkError").[iterator]`
...
`Data.TaggedError("InkError").[NodeInspectSymbol]`
...
`Data.TaggedError("InkError").pipe`
...
`Data.TaggedError("InkError").toJSON`
...
`Data.TaggedError("InkError").toString`
