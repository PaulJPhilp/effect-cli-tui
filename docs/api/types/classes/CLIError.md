...
[effect-cli-tui](../../modules.md) / [types](../README.md) / CLIError

# Class: CLIError

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:27](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L27)
...
> **new CLIError**(`reason`, `message`, `exitCode?`): `CLIError`

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:28](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L28)

#### Parameters

##### reason

`"CommandFailed"` | `"Timeout"` | `"NotFound"` | `"ExecutionError"`
...
`Data.TaggedError("CLIError").constructor`
...
`Data.TaggedError("CLIError")._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `CLIError`, `unknown`, `never`, `unknown`, `never`\>
...
`Data.TaggedError("CLIError").[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `CLIError`, `never`\>
...
`Data.TaggedError("CLIError").[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `CLIError`, `never`\>
...
`Data.TaggedError("CLIError").[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `CLIError`, `never`\>
...
`Data.TaggedError("CLIError").[StreamTypeId]`
...
`Data.TaggedError("CLIError").cause`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:35](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L35)
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:34](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L34)

#### Inherited from

`Data.TaggedError("CLIError").message`
...
`Data.TaggedError("CLIError").name`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:29](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L29)
...
`Data.TaggedError("CLIError").stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `CLIError`, `never`\>\>
...
`EffectGenerator`\<`Effect`\<`never`, `CLIError`, `never`\>\>

#### Inherited from

`Data.TaggedError("CLIError").[iterator]`
...
`Data.TaggedError("CLIError").[NodeInspectSymbol]`
...
`Data.TaggedError("CLIError").pipe`
...
`Data.TaggedError("CLIError").toJSON`
...
`Data.TaggedError("CLIError").toString`
