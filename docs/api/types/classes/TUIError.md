...
[effect-cli-tui](../../modules.md) / [types](../README.md) / TUIError

# Class: TUIError

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:41](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L41)
...
> **new TUIError**(`reason`, `message`): `TUIError`

Defined in: [Projects/Published/effect-cli-tui/src/types.ts:42](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L42)

#### Parameters

##### reason

`"Cancelled"` | `"ValidationFailed"` | `"RenderError"`
...
`Data.TaggedError("TUIError").constructor`

## Properties

### \_tag

> `readonly` **\_tag**: `"TUIError"`
...
`Data.TaggedError("TUIError")._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `TUIError`, `unknown`, `never`, `unknown`, `never`\>
...
`Data.TaggedError("TUIError").[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `TUIError`, `never`\>
...
`Data.TaggedError("TUIError").[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `TUIError`, `never`\>
...
`Data.TaggedError("TUIError").[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `TUIError`, `never`\>
...
`Data.TaggedError("TUIError").[StreamTypeId]`
...
`Data.TaggedError("TUIError").cause`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:44](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L44)

#### Inherited from

`Data.TaggedError("TUIError").message`
...
`Data.TaggedError("TUIError").name`
...
Defined in: [Projects/Published/effect-cli-tui/src/types.ts:43](https://github.com/PaulJPhilp/effect-cli-tui/blob/aa147251d5ae83d3a9b8e78ec31fb58f1419a00b/src/types.ts#L43)
...
`Data.TaggedError("TUIError").stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `TUIError`, `never`\>\>
...
`EffectGenerator`\<`Effect`\<`never`, `TUIError`, `never`\>\>

#### Inherited from

`Data.TaggedError("TUIError").[iterator]`
...
`Data.TaggedError("TUIError").[NodeInspectSymbol]`
...
`Data.TaggedError("TUIError").pipe`
...
`Data.TaggedError("TUIError").toJSON`
...
`Data.TaggedError("TUIError").toString`
